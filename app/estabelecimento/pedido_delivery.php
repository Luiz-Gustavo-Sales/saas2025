...
if( $data_content['calcular_frete'] == '1' ) {
	include $virtualpath.'/pedido_delivery_frete.php';
	exit();
}
						...
						<div class="pedido-actions">
							...
							<div class="row">
								...
								<div class="col-md-3 col-xs-7 col-sm-7">
									...
									<button class="botao-acao"><i class="lni lni-whatsapp"></i> <span>Finalizar Pedido</span></button>
