<nav class="navbar pull-left">
	<ul class="nav navbar-nav">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu">
				<li><a href="<?php panel_url(); ?>/mesas"><i class="lni lni-dinner"></i> Gerenciar Mesas</a></li>
				<li><a href="<?php panel_url(); ?>/garcons"><i class="lni lni-users"></i> Gerenciar Garçons</a></li>
			</ul>
		</li>
		<?php } ?>
