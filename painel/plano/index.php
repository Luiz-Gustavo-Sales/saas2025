							...
							<div class="panel-body panel-body-planos">
								...
								<div class="plano plano-interna">
									...
									<div class="content">
										...
										<!--<div class="row">
											<div class="col-md-9 col-sm-9 col-xs-9">
												<span class="info">Comissionamento:</span>
											</div>-->
											<!--<div class="col-md-3 col-sm-3 col-xs-3">
											    <?php
											        $comissionamento_query = mysqli_query($db_con, "SELECT comissionamento FROM `assinaturas` WHERE `rel_estabelecimentos_id` = '$eid'");
											        $tem_comissionamento = mysqli_fetch_array($comissionamento_query);
											        
											    ?>
												<?php if( $tem_comissionamento[0] == "1" ) { ?>
													<span class="badge badge-concluido pull-right">Sim</span>
												<?php } else { ?>
													<span class="badge badge-cancelado pull-right">Não</span>
												<?php } ?>
