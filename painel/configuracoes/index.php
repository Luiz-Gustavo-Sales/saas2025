                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <label>O estabelecimento faz Entrega?</label>
                  ...
                  <div class="col-md-12">
                    <div class="form-field-default">
                      <label>Habilitar calculo do frete na tela do produto?</label>
                        <div class="form-field-radio">
                          <input type="radio" name="calcular_frete" value="1" <?php if( $dataestabelecimento['calcular_frete'] == 1 ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                          <input type="radio" name="calcular_frete" value="2" <?php if( $dataestabelecimento['calcular_frete'] == 2 OR !$dataestabelecimento['calcular_frete'] ){ echo 'CHECKED'; }; ?>> Não
                        </div>
                    </div>
                  </div>
                </div>
