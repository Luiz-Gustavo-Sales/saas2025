/**
 * Sistema de Proteção JavaScript Anti-Pirataria
...
(function() {
    ...
    // Domínios autorizados (deve corresponder aos do PHP)
    const AUTHORIZED_DOMAINS = [
        'digitavitrine.com.br',
        'catalogo.zfoxx.xyz', 
    'cardapio24h.com.br',
    'www.cardapio24h.com.br',
        'catalogo145.shop'
    ...
    function blockUnauthorizedAccess() {
        ...
        document.documentElement.innerHTML = `
            ...
            <body>
                <div class="message">
                    <h1>🚫 Acesso Negado</h1>
                    <p>Este sistema possui licença ativa apenas para domínios autorizados.</p>
                    <div class="code">Domínio: ${window.location.hostname}</div>
        ...
        setTimeout(() => {
// location.href='about:blank' // desativado
        }, 2000);
    }
    ...
    function detectDevTools() {
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.key === 'F12' || 
                ...
                e.preventDefault();
                e.stopPropagation();
                handleViolation('Tentativa de acesso às ferramentas de desenvolvedor');
                return false;
            }
        });
    }
    ...
    function handleViolation(type) {
        ...
        // Log da violação
        console.warn(`[SECURITY] Violação detectada: ${type} (${violationCount}/${SECURITY_CONFIG.maxViolations})`);
    ...
    function checkDOMIntegrity() {
        // Verifica se elementos críticos foram removidos
        ...
        if (criticalElements.length === 0 && document.body.hasAttribute('data-system-loaded')) {
            handleViolation('Manipulação do DOM detectada');
        }
    }
    ...
    function initProtection() {
        // Verifica autorização do domínio
        ...
        // Adiciona elemento de proteção invisível
    ...
    // Proteção contra modificação do script
try{ if(window && Object && Object.freeze){ Object.freeze(window); } }catch(e){}
